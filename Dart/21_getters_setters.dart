...
class Student {
  ...
  // Instance variable with Custom Setter and Setter must have only one positional argument
  void set percentage(double marksSecured) => this._percent = (marksSecured / 500) * 100;
