...
// element.innerText = '<b>Hello this is created by keyur</b>';
// element.innerHTML = '<b>Hello this is created by keyur</b>';
...
// myul.replaceChild(element, document.getElementById('fui'));   //replaceChild(new, old)
