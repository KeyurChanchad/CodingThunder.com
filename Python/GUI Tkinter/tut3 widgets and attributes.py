...
grid() method: It organizes the widgets in the grid (table-like structure) before placing in the parent widget.
...
Tkinter Widget padding: padx and pady –these two attributes come under this which, respectively, add extra horizontal and vertical space to the widget. The padx and pady attributes add space between the buttons.

Tkinter Background colors: The background colors of widgets can be set with background attribute. It can be abbreviated to bg.
